...
- **Woodpecker CI** runs on push/PR: secret-scan (gitleaks), lint, test, typecheck, Dockerfile lint, compose policy checks, conditional Docker builds, image CVE scans, SBOM generation, and isolated runtime smoke tests for MCP stack changes
