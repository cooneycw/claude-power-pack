...
declare -A EXTRA_FILES=(
    ...
    [flow]="scripts/flow-start-resolve.sh scripts/flow-live-driver-guard.sh scripts/flow-worktree-claim.sh scripts/flow-wave-registry.sh scripts/flow-wave-plan.py scripts/flow-finish-gate.sh scripts/flow-stale-check.sh scripts/flow-worktree-guard.sh scripts/gh-pr-merge.sh scripts/worktree-remove.sh scripts/friction-log.sh scripts/check-ignored-additions.sh scripts/flow-helpers-install.sh"
