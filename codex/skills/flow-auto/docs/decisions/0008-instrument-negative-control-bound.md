...
| 103 | `codex-install-proof.sh` | `PROOF: ok` / `PROOF_FAIL: <finding>`, plus a `PROOF_NOT_RUN:` line per uninspected cell | `make verify`; CI `codex-install-proof` | G |
